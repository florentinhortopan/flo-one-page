...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openModal(roleElement) {
        ...
        if (popupFile) {
            ...
            // Show placeholder content for missing popups
            modalBody.innerHTML = `
                <div style="padding: 40px; text-align: center;">
                    <h2 style="font-size: 32px; margin-bottom: 20px; color: #000;">${roleElement.textContent}</h2>
                    <p style="font-size: 18px; color: #666; margin-bottom: 20px;">Content coming soon...</p>
                    <p style="font-size: 16px; color: #999;">This section is being prepared for deployment.</p>
                </div>
            `;
            modalOverlay.classList.add('active');
            document.body.style.overflow = 'hidden';
            console.log('Modal opened with placeholder content');
        }
    }
