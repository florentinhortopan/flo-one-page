...
const HeroSection = ({
  ...
  tagline = "UX and AI for humanity-centered products. ",
  description = "Transforming digital experiences through UX strategy, Design Systems, and design operations. Let's create exceptional user experiences together.",
